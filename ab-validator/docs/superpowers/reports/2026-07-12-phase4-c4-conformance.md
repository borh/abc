...
| accent_dot_above | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| accent_dot_below | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| accent_dot_cluster | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| accent_dot_ordinal | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| accent_dot_tortoise | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| accent_dot_uppercase | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| align_end_container | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| angle_quote | angle_quote | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| annotation | annotation | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| body_end | structural-marker | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| boki | kunten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bold_block | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bold_forward | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bold_forward_interior | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bold_inline | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten | bouten | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_black_triangle | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_chain_line | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_forward_interior | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_range | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_range_chain_line | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| bouten_target_ambiguous | bouten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| box_enclosure | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| break_in_single_line_container | break | should | aozora-adapter | warning |  | nodes: kind sequence differs
      ...
      got:      ['emphasis', 'pageBreak'] | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| center_page | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| correction_sic | annotation | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| editor_note | annotation | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| emphasis_mixed | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| font_size_bare_range | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| font_size_block | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| forced_break | structural-marker | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| fraction_forward | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| gaiji | gaiji | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| gaiji_composed_glyph | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| gaiji_composed_seiji | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| gaiji_double_paren | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| head_flush_single | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading | heading | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_block | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_hint | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_paired_window | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_promoted | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_ruby_hint | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| heading_window | heading | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| horizontal_container | horizontal | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| indent_center | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| indent_compound_styled | layout | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| indent_container | container | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| indent_from_top | container | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| indent_line_kumi | container | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| italic_block | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| italic_forward | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| italic_inline | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| kaeriten_outside_kanbun | kunten | may | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| keigakomi_container | container | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| left_ruby | kunten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| left_ruby_pair | annotation | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| line_bold_single | layout | should | aozora-adapter | warning |  | nodes: kind sequence differs
      expected: ['lineBold']
      got:      ['lineGothic'] | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| line_font_size_single | layout | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| line_width_container | container | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| mismatched_container_close | container | should | aozora-adapter | warning |  | nodes: kind sequence differs
      expected: ['containerOpen', 'containerClose']
      got:      ['containerOpen', 'containerClose', 'containerClose'] | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| mixed_ruby_bouten | composite | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| nested_ruby | ruby | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| page_break | break | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| pageful | composite | may | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| plain_text | plain | must | aozora-adapter | skip |  |  | nodes: vector has no expected.nodes<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| pua_collision | recovery | must | aozora-adapter | skip |  |  | nodes: vector has no expected.nodes<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| roman_numeral | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| ruby_attached | annotation | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| ruby_explicit | ruby | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| ruby_implicit | ruby | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| ruby_retarget | annotation | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| sashie | sashie | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| sashie_caption | sashie | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| sashie_dimensions | sashie | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| section_break | break | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| side_glyph_left | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| side_glyph_left_range | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| side_glyph_right | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| side_glyph_right_range | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| side_note_left | kunten | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| standalone_gaiji | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| subscript_forward | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| superscript_forward | emphasis | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| table_container | tables_columns | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| tate_chu_yoko | tcy | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| tate_chu_yoko_found | tate_chu_yoko | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| unclosed_bracket | recovery | must | aozora-adapter | skip |  |  | nodes: vector has no expected.nodes<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| unresolved_gaiji | gaiji | should | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
...
| warichu_inline | warichu | must | aozora-adapter | pass |  |  | pairs: not comparable for AAT adapter (kind-sequence only)<br>serialize: not comparable for AAT adapter (kind-sequence only)<br>html: not comparable for AAT adapter (kind-sequence only)<br>diagnostics: not comparable for AAT adapter (kind-sequence only) |
