...
fn reseal_ledger(generation: &mut ab_capture::CaptureGeneration, ledger: &Value) {
...
fn reseal_manifest(generation: &mut ab_capture::CaptureGeneration, mut manifest: Value) {
