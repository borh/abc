...
(deftest contract-scalar-schemas-test
  (testing "shared scalar schemas accept valid values"
    (is (valid? ::am/nonblank-string "abc"))
    (is (valid? ::am/nullable-nonblank-string nil))
    (is (valid? ::am/nullable-nonblank-string "abc"))
    ...
    (is (valid? ::am/workspace-logical-path "abc/docs/report.md"))
  ...
  (testing "shared scalar schemas reject invalid values"
    ...
    (is (not (valid? ::am/workspace-logical-path "../abc/docs/report.md")))
    (is (not (valid? ::am/workspace-logical-path "/abc/docs/report.md")))
