  ...
  artifacts =
    pkgs.runCommand "soranoha-tei-profile-artifacts"
      ...
      ''
        ...
        # The snh- prefix distinguishes this profile's declared constraints from
        # the inherited TEI built-ins that the awk script below drops. A
        # constraintSpec/@ident that stops matching is not renamed here and
        # would be dropped by awk; the count guard after the filter fails the
        # build if the match count changes.
