...
| bucket | rows |
|---|---:|
| base_drop_parentheticals_equal | 2 |
| base_equal | 4 |
| different | 33 |
| ruby_expanded_equal | 3 |
| ruby_expanded_parenless_equal | 35 |
...
|---|---|---:|---|
| drama | Drama | 30 | `LANE_POLICY_REQUIRED` |
| front_back_matter | Front/back matter | 6 | `LANE_POLICY_REQUIRED` |
| lv4_enrichment | Level 4 enrichment | 29 | `LANE_OUT_OF_SCOPE_FOR_LEVEL3` |
| notes | Notes | 21 | `LANE_POLICY_REQUIRED` |
| plain_prose | Plain prose | 81 | `LANE_READY_FOR_GATE_IMPLEMENTATION` |
