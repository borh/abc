...
- generated_unix_seconds: `1783766802`
...
|---:|---:|---:|---:|---:|---:|---:|
| 17886 | 17886 | 0 | 18786700 | 200711 | 4610592 | 10.292 |

## Inputs

| label | files | aat_dir |
|---|---:|---|
| ab-aozora | 17886 | `/db/ab-validator/aat-corpus/ab-aozora-phase3-capability-a81edf0/aat/ab-aozora` |

## Corpus Results

| corpus | attempted | succeeded | failed | parser_ir_nodes | divergence_occurrences |
|---|---:|---:|---:|---:|---:|
| ab-aozora | 17886 | 17886 | 0 | 18786700 | 4610592 |
...
|---|---:|---:|---:|
| ab-aozora | 198517 | 7592 | 0 |

| inferred_provenance | nodes |
|---|---:|
| parser-derived | 185875 |
| source-derived | 12642 |

| source_class | nodes |
|---|---:|
| aozora-marker | 191276 |
| editorial-note | 5 |
| text | 7236 |
...
|---|---|---|---|---:|---:|---:|---:|---:|
| ab-aozora | ab-aozora 0.2.0 aat-schema 1 facade 0.2.0 wire-schema 3 (git a81edf066ecc0e9ac12e04c4ccc2551c27009161) | 0.2.8 | `sha256:952620ced4eb22f9771e6a10c3a1d4d93de604a8c33e360311f82b6e1eafc5b7` | 17886 | 0 | 47 | 633 | 198831 |
