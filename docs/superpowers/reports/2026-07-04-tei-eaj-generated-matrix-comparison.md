...
| bucket | rows |
|---|---:|
| adapter_collapsed | 35 |
| adapter_over_segmented | 127 |
| adapter_under_segmented | 13 |
| aligned | 37 |
| empty_body_paragraph_range | 1 |
...
| bucket | rows |
|---|---:|
| base_drop_parentheticals_equal | 20 |
| base_drop_parentheticals_generated_contains_tei_eaj | 2 |
| base_equal | 7 |
| different | 129 |
| ruby_expanded_equal | 4 |
| ruby_expanded_parenless_equal | 46 |
| ruby_expanded_parenless_generated_contains_tei_eaj | 10 |
...
| profile | origin | rows |
|---|---|---:|
| drama | adapter_collapsed | 11 |
| drama | adapter_over_segmented | 12 |
| drama | adapter_under_segmented | 7 |
| drama | aligned | 1 |
| drama | empty_body_paragraph_range | 1 |
| drama | page_break_projection | 2 |
| front_back_matter | adapter_collapsed | 1 |
| front_back_matter | adapter_over_segmented | 5 |
| front_back_matter | aligned | 2 |
| lv4_enrichment | adapter_collapsed | 8 |
...
| aozora2 | collapsed | 18 |
| aozora2 | exact | 19 |
| aozora2 | over_split | 4 |
| aozora2 | under_split | 7 |
| aozora2html | exact | 5 |
...
| aozora-rs | aligned | 6 |
| aozora2 | adapter_collapsed | 18 |
| aozora2 | adapter_over_segmented | 4 |
| aozora2 | adapter_under_segmented | 6 |
| aozora2 | aligned | 19 |
| aozora2 | empty_body_paragraph_range | 1 |
...
| aozora2 | base_drop_parentheticals_equal | 16 |
| aozora2 | base_drop_parentheticals_generated_contains_tei_eaj | 2 |
| aozora2 | base_equal | 1 |
| aozora2 | different | 24 |
| aozora2 | ruby_expanded_equal | 1 |
| aozora2 | ruby_expanded_parenless_equal | 3 |
| aozora2 | ruby_expanded_parenless_generated_contains_tei_eaj | 1 |
...
| 42320 | `data/complete/tei_lib_lv3/42320_tei.xml` | aozora2 | 1 | 1 | 1 | 3 | -2 | collapsed | adapter_collapsed | different | base_drop_parentheticals_generated_contains_tei_eaj | - |
...
| 4411 | `data/complete/tei_lib_lv3/4411_tei.xml` | aozora2 | 1 | 1 | 1 | 2 | -1 | collapsed | adapter_collapsed | different | base_drop_parentheticals_equal | - |
...
| 53617 | `data/complete/tei_lib_lv3/53617_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_generated_contains_tei_eaj | - |
...
| 56996 | `data/complete/tei_lib_lv3/56996_tei.xml` | aozora2 | 3 | 3 | 3 | 1 | 2 | over_split | adapter_over_segmented | different | base_drop_parentheticals_equal | - |
...
| 56998 | `data/complete/tei_lib_lv3/56998_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 56999 | `data/complete/tei_lib_lv3/56999_tei.xml` | aozora2 | 1 | 1 | 1 | 8 | -7 | collapsed | adapter_collapsed | different | different | - |
...
| 57001 | `data/complete/tei_lib_lv3/57001_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57003 | `data/complete/tei_lib_lv3/57003_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57004 | `data/complete/tei_lib_lv3/57004_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57005 | `data/complete/tei_lib_lv3/57005_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57006 | `data/complete/tei_lib_lv3/57006_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | different | - |
...
| 57037 | `data/complete/tei_lib_lv3/57037_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | different | - |
...
| 57038 | `data/complete/tei_lib_lv3/57038_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57039 | `data/complete/tei_lib_lv3/57039_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57040 | `data/complete/tei_lib_lv3/57040_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57041 | `data/complete/tei_lib_lv3/57041_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57042 | `data/complete/tei_lib_lv3/57042_tei.xml` | aozora2 | 1 | 1 | 1 | 1 | 0 | exact | aligned | different | base_drop_parentheticals_equal | - |
...
| 57046 | `data/complete/tei_lib_lv3/57046_tei.xml` | aozora2 | 2 | 2 | 2 | 1 | 1 | over_split | adapter_over_segmented | different | base_drop_parentheticals_equal | - |
...
| 57047 | `data/complete/tei_lib_lv3/57047_tei.xml` | aozora2 | 2 | 2 | 2 | 1 | 1 | over_split | adapter_over_segmented | different | base_drop_parentheticals_equal | - |
...
| 1576 | `data/draft/tei_lib_lv3/1576_tei.xml` | aozora2 | 7 | 7 | 6 | 496 | -490 | under_split | empty_body_paragraph_range | different | different | - |
