---
plan_id: "2026-04-26-aozora-syntax-coverage-increment"
status: done
started: 2026-04-27
...
- [x] **Step 1: Write the failing matrix parser tests**
...
- [x] **Step 1: Write failing source projection tests**
...
- [x] **Step 3: Implement `source_projection::comparison_lossy_body`**
...
- [x] **Step 2: Run formatting and status checks**
