...
| [package-scoped-instrument-dependency-identity](package-scoped-instrument-dependency-identity.md) | Scope Instrument Dependency Identity to the Package, Not the Workspace | accepted | 2026-07-26 | parser, release |  |
...
| [parser-release-instrument-bindings](parser-release-instrument-bindings.md) | Bind Final Parser Release Instruments | accepted | 2026-07-17 | parser, release | amended by [package-scoped-instrument-dependency-identity](package-scoped-instrument-dependency-identity.md) [scope: instrument semantic identity and its dependency boundary]; depended on by [custom-parser-release-qualification](custom-parser-release-qualification.md); depended on by [portable-parser-rq-evidence-integrity](portable-parser-rq-evidence-integrity.md) |
